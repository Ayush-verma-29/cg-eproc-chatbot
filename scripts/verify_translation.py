...
def verify():
    print("Verifying integrated translation service...")
    ...
    print("\n--- FINAL TRANSLATION ---")
    with open("scripts/verify_output.txt", "w", encoding="utf-8") as f:
        f.write(res)
    print("Output written to scripts/verify_output.txt")
    print("-------------------------")
